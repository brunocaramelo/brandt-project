...
<section id="blog" class="blog section-padding bg-grey" data-scroll-index="4">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="title mb-30"> <span>Instituto</span>
                    <h2 class="animate-box" data-animate-effect="fadeInLeft">Patrícia Brandt Schefer</h2>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title mb-30">
                    <h2 class="animate-box" data-animate-effect="fadeInLeft">MISSÃO</h2>
                    <hr class="line line-hr-secondary">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title mb-30">
                    <h2 class="animate-box" data-animate-effect="fadeInLeft">VISÃO</h2>
                    <hr class="line line-hr-secondary">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title mb-30">
                    <h2 class="animate-box" data-animate-effect="fadeInLeft">VALORES</h2>
                    <hr class="line line-hr-secondary">
                </div>
            </div>
