...
<header class="header valign bg-img parallaxie" id="banner-top-rotate" id="banner-top-rotate" data-scroll-index="0" data-overlay-dark="0" data-background="img/banner_about.jpg" style="background-position: left;" location-page="about">
