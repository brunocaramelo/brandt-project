...
<header class="header valign bg-img parallaxie" id="banner-top-rotate" style="background-position: left;background-color:#000" data-scroll-index="0" data-overlay-dark="0" data-background="img/banner_site_home_01.jpg" location-page="home" />
    <div class="container">
        {{-- <div class="row">
