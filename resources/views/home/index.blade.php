...
<header class="header valign bg-img parallaxie" id="banner-top-rotate" style="background-position: left;" data-scroll-index="0" data-overlay-dark="0" data-background="img/bg-phot-home.jpeg" />
    <div class="container">
        {{-- <div class="row">
